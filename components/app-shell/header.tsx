...
export function Header({
  ...
  return (
    <header className="relative flex h-15 shrink-0 items-center justify-between border-b border-border bg-background/95 px-4 backdrop-blur sm:px-6">
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            {admin && (
              <span className="hidden items-center gap-1 rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-bold text-primary sm:inline-flex">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        ...
        <div ref={ref}>
          <button
            ...
            className="hidden items-center gap-2 rounded-lg px-2 py-1.5 hover:bg-muted sm:flex"
            aria-expanded={open}
          >
          ...
          {open && (
            <div className="absolute right-4 top-13 z-40 w-64 rounded-xl border border-border bg-popover p-2 shadow-xl">
              ...
              <button
                ...
                className="mt-2 flex w-full items-center gap-2 rounded-lg px-2 py-2 text-sm hover:bg-muted"
              >
      ...
      {notice && (
        <div className="absolute right-4 top-13 z-30 w-72 rounded-xl border border-border bg-card p-3 text-sm shadow-lg">
          <p className="font-semibold">Your next focus is ready</p>
          <p className="mt-1 text-xs leading-5 text-muted-foreground">
            Continue System Design Fundamentals to keep your readiness
            momentum.
          </p>
        </div>
      )}
