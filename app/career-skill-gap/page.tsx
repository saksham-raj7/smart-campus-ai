...
export default function CareerSkillGapPage() {
  ...
  return <AppShell title="Career & Skill Gap"><div className="mx-auto flex w-full max-w-7xl flex-col gap-5">
    <section className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><div className="mb-2 flex items-center gap-2 text-xs font-medium text-primary"><span className="flex size-5 items-center justify-center rounded-md bg-primary/10"><Sparkles className="size-3" aria-hidden="true" /></span>AI-POWERED ROLE MATCH</div><h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">Career &amp; Skill Gap</h2><p className="mt-1.5 max-w-2xl text-sm leading-6 text-muted-foreground">AI compares your current capabilities with the skills most important for your target role, so you can focus your effort where it matters.</p></div><span className="w-fit rounded-full border border-border bg-card px-3 py-1.5 text-xs text-muted-foreground">Demo data · Personalization coming soon</span></section>
